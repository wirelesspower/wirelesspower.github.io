...
<!-- .slide: class="center" data-background="#035084" -->
<!-- .slide: style="margin-left: 50px;"-->

# Wireless Power Transfer

### An Introduction to IPT Technology

<small>Written by [Duleepa J Thrimawithana](http://) / [@DuleepaJT](d.thrimawithana@auckland.ac.nz)</small>
...
- Can be divided in to two broad categories
 - Radiative transmission through far-field principles
   ...
   - Start-up companies such as ubeam, energous, etc. are working in this space
   - AirFuel Alliance is developing standards
 - Non-radiative transmission through near-field principles
   - Inductive power transfer and capacitive power transfer technologies are utilised
   - A number of companies such a Daifuku, Conductix Wampfler, Qualcomm, Power by Proxi, WitriCity, Bombardier, Wave IPT etc. are working in this space
   - WPC, SAE standards have been developed 
...
# Using Columns
  ...
  <div class="twocolumn73" class="lsdt">
  

    <div>
    <ul> 
  <li>List Item1 List Item1 List Item1 List Item1</li>
  <li>List Item2</li>
  <li>List Item3</li>
  </ul> 
    </div>
...
<!-- .slide: data-background="https://cpb-ap-se2.wpmucdn.com/blogs.auckland.ac.nz/dist/d/79/files/2015/10/uoa-v-colour2.png" data-background-size="30%"-->
...
```markdown
<!-- .slide: data-background="http://i.giphy.com/90F8aUepslB84.gif" data-background-size="100px" -->
```
